...
const ETHICS = {
  ro: {
    ...
    intro: 'Privon Foundation oferă instrumente de securitate și confidențialitate pentru a proteja oamenii, nu pentru a face rău. Acest cod de etică stabilește așteptările noastre și limitele legale.',
    ...
    contact: 'Contact',
    contactDesc: 'Dacă ai întrebări despre acest cod de etică sau vrei să raportezi o utilizare greșită, contactează-ne la: privon.dev@tuta.io'
  },
  en: {
    title: 'Code of Ethics',
    lastUpdated: 'Last updated: May 2026',
    intro: 'Privon Foundation provides security and privacy tools to protect people, not to cause harm. This code of ethics establishes our expectations and legal boundaries.',
    ...
    contact: 'Contact',
    contactDesc: 'If you have questions about this code of ethics or want to report misuse, contact us at: privon.dev@tuta.io'
  },
  es: {
    title: 'Código de Ética',
    lastUpdated: 'Última actualización: Mayo 2026',
    intro: 'Privon Foundation proporciona herramientas de seguridad y privacidad para proteger a las personas, no para causar daño. Este código de ética establece nuestras expectativas y límites legales.',
    ...
    contact: 'Contacto',
    contactDesc: 'Si tienes preguntas sobre este código de ética o quieres reportar un uso indebido, contáctanos en: privon.dev@tuta.io'
  }
};
...
const EthicsPage: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Code of Ethics"
        description="Privon Foundation Code of Ethics — security and privacy tools to protect people, not to cause harm. Ethical hacking, responsible disclosure."
        path="/ethics"
      />
