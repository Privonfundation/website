...
const TERMS = {
  ro: {
    ...
    intro: 'Bine ai venit la Privon Foundation. Folosind site-ul și serviciile noastre, ești de acord cu următorii termeni și condiții.',
    ...
    servicesDesc: 'Privon Foundation oferă soluții de securitate cibernetică, instrumente de confidențialitate și aplicații open-source. Toate serviciile noastre sunt furnizate „ca atare", în conformitate cu principiile Protocolului 3305 — zero colectare de date, zero încredere, zero cunoștințe.',
    ...
    intellectualDesc: 'Tot codul, designul, conținutul și materialele site-ului Privon Foundation sunt licențiate sub AGPL-3.0, cu excepția cazului în care se specifică altfel. Ești liber să folosești, modifici și distribui codul în conformitate cu termenii AGPL-3.0.',
    license: 'AGPL-3.0',
    ...
    liabilityDesc: 'În cea mai mare măsură permisă de lege, Privon Foundation nu va fi răspunzătoare pentru daune directe, indirecte, accidentale sau consecutive rezultate din folosirea sau imposibilitatea de a folosi serviciile noastre. Deoarece nu colectăm date, nu putem fi considerați responsabili pentru pierderea de date care oricum nu există.',
    ...
    contact: 'Contact',
    contactDesc: 'Pentru întrebări legate de acești termeni, contactează-ne la: privon.dev@tuta.io'
  },
  en: {
    title: 'Terms and Conditions',
    lastUpdated: 'Last updated: May 2026',
    intro: 'Welcome to Privon Foundation. By using our website and services, you agree to the following terms and conditions.',
    ...
    servicesDesc: 'Privon Foundation provides cybersecurity solutions, privacy tools, and open-source applications. All our services are provided "as is" in accordance with the principles of Protocol 3305 — zero data collection, zero trust, zero knowledge.',
    ...
    intellectualDesc: 'All code, design, content, and materials on the Privon Foundation website are licensed under AGPL-3.0, unless otherwise specified. You are free to use, modify, and distribute the code in accordance with the terms of AGPL-3.0.',
    ...
    liabilityDesc: 'To the maximum extent permitted by law, Privon Foundation shall not be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use our services. Since we do not collect data, we cannot be held liable for data loss that does not exist.',
    ...
    contact: 'Contact',
    contactDesc: 'For questions regarding these terms, contact us at: privon.dev@tuta.io'
  },
  es: {
    title: 'Términos y Condiciones',
    lastUpdated: 'Última actualización: Mayo 2026',
    intro: 'Bienvenido a Privon Foundation. Al usar nuestro sitio web y servicios, aceptas los siguientes términos y condiciones.',
    ...
    servicesDesc: 'Privon Foundation proporciona soluciones de ciberseguridad, herramientas de privacidad y aplicaciones de código abierto. Todos nuestros servicios se proporcionan "tal cual" de acuerdo con los principios del Protocolo 3305 — cero recopilación de datos, cero confianza, cero conocimiento.',
    ...
    intellectualDesc: 'Todo el código, diseño, contenido y materiales del sitio web de Privon Foundation están licenciados bajo AGPL-3.0, a menos que se especifique lo contrario. Eres libre de usar, modificar y distribuir el código de acuerdo con los términos de AGPL-3.0.',
    ...
    liabilityDesc: 'En la máxima medida permitida por la ley, Privon Foundation no será responsable por daños directos, indirectos, incidentales o consecuentes derivados del uso o la imposibilidad de usar nuestros servicios. Dado que no recopilamos datos, no podemos ser responsables por la pérdida de datos que no existen.',
    ...
    contact: 'Contacto',
    contactDesc: 'Para preguntas sobre estos términos, contáctanos en: privon.dev@tuta.io'
  }
};
...
const TermsAndConditions: React.FC = () => {
  ...
  return (
    <>
      <Seo
        title="Terms and Conditions"
        description="Terms and conditions for Privon Foundation services and applications. AGPL-3.0 licensed, zero data collection, no warranty."
        path="/terms"
      />
